...
const siteListColumn = [
    ...
    {
        title: <div style={{ fontSize: '14px', color: '#CDD1D2', textAlign: 'center' }}>Location Name</div>,
        dataIndex: 'loc_name',
        key: 'loc_name',
        render: (text) => {
            return {
    ...
    {
        title: <div style={{ fontSize: '14px', color: '#CDD1D2', textAlign: 'center' }}>Site Name</div>,
        dataIndex: 'site_name',
        key: 'site_name',
        render: (text) => {
            return {
