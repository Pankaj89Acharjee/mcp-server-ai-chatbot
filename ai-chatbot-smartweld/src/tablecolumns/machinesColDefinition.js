...
const machinesColumn = [
    ...
    {
        title: <div style={{ fontSize: '14px', color: '#CDD1D2', textAlign: 'center' }}>Serial No.</div>,
        dataIndex: 'mc_serial_no',
        key: 'mc_serial_no',
        render: (text) => {
            return {
                props: {
    ...
    {
        title: <div style={{ fontSize: '14px', color: '#CDD1D2', textAlign: 'center' }}>Machine Type</div>,
        dataIndex: 'mt_name',
        key: 'mt_name',
        render: (text) => {
            return {
    ...
    {
        title: <div style={{ fontSize: '14px', color: '#CDD1D2', textAlign: 'center' }}>Machine Status</div>,
        dataIndex: 'ms_name',
        key: 'ms_name',
        render: (text) => {
            return {
