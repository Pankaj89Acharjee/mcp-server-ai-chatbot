...
const machineHardareColumn = [
    ...
    {
        title: <div style={{ fontSize: '14px', color: '#CDD1D2', textAlign: 'center' }}>Hardware Name</div>,
        dataIndex: 'hw_name',
        key: 'hw_name',
        render: (text) => {
            return {
    ...
    {
        title: <div style={{ fontSize: '14px', color: '#CDD1D2', textAlign: 'center' }}>Creation Date</div>,
...
export default machineHardareColumn