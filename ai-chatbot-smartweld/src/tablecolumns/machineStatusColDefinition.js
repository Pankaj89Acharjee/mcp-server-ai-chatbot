...
const machineStatusColumn = [
    ...
    {
        title: <div style={{ fontSize: '14px', color: '#CDD1D2', textAlign: 'center' }}>Machine Description</div>,
        dataIndex: 'ms_description',
        key: 'ms_description',
        render: (text) => {
            return {
                props: {
...
export default machineStatusColumn