...
const powerSpecsListColumn = [
    ...
    {
        title: <div style={{ fontSize: '14px', color: '#CDD1D2', textAlign: 'center' }}>Power Name</div>,
    ...
    {
        title: <div style={{ fontSize: '14px', color: '#CDD1D2', textAlign: 'center' }}>Efficiency</div>,
    ...
    {
        title: <div style={{ fontSize: '14px', color: '#CDD1D2', textAlign: 'center' }}>Cost/Unit</div>,
...
export default powerSpecsListColumn