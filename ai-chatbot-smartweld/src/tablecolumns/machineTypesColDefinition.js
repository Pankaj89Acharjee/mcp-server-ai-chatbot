...
const machineTypesColumn = [
    ...
    {
        title: <div style={{ fontSize: '14px', color: '#CDD1D2', textAlign: 'center' }}>Machine Code</div>,
        dataIndex: 'mt_code',
        key: 'mt_code',
        render: (text) => {
            return {
    ...
    {
        title: <div style={{ fontSize: '14px', color: '#CDD1D2', textAlign: 'center' }}>Line Name</div>,
        dataIndex: 'lt_name',
        key: 'lt_name',
        render: (text) => {
            return {
    ...
    {
        title: <div style={{ fontSize: '14px', color: '#CDD1D2', textAlign: 'center' }}>Description</div>,
    ...
    {
        title: <div style={{ fontSize: '14px', color: '#CDD1D2', textAlign: 'center' }}>Created On</div>,
...
export default machineTypesColumn